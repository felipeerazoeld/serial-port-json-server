...
echo "About to cross-compile Serial Port JSON Server with Go 1.12"
if [ "$1" = "" ]; then
...
cp README.md snapshot/serial-port-json-server-$1_linux_amd64/
...
cp README.md snapshot/serial-port-json-server-$1_linux_386/
...
cp README.md snapshot/serial-port-json-server-$1_linux_arm/
...
cp README.md snapshot/serial-port-json-server-$1_windows_386/
...
zip a ../serial-port-json-server-$1_windows_386.zip *
cd ../..
...
cp README.md snapshot/serial-port-json-server-$1_windows_amd64/
...
zip a ../serial-port-json-server-$1_windows_amd64.zip *
cd ../..
...
cp README.md snapshot/serial-port-json-server-$1_darwin_amd64/
